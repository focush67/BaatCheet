...
import { messages, requests, blocked } from "@/constants/data";
...
export default function MessageScreen() {
  ...
  return (
    <View className="flex-1 bg-white dark:bg-black">
      ...
      <MessageSearch isDark={isDark} />
      <Notes />

      {/* Tabs */}
      <View className="flex-row justify-around border-gray-300 dark:border-gray-700 py-2">
